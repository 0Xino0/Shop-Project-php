...
<body>
    <nav class="navbar navbar-expand-md bg-dark navbar-dark ">
        <a class="navbar-brand" href="index.php"><i class="fa-solid fa-shop" style="color: #ffffff;"></i>&nbsp;&nbsp;Add
            Product</a>
    ...
    <div class="container-fluid">
        ...
        <div class="row flex-nowrap">
            <div class="bg-dark col-2 min-vh-100 ">
                <div class="bg-dark p-2">
                    <h2 class="d-flex text-decoration-none text-white align-items-center mt-1 px-5">Category</h2>
                    <?php 
                    $res_cat = sidebar_category($conn);
                    ...
                    <ul class="nav nav-pills flex-column">
                        <li class="nav-item py-2 py-sm-0">
                            <form action="category.php" method="get">
                                <input type="hidden" name="sidebar_category" id="sidebar_category" value="<?php echo $row['id'] ?>">
                                <button type="submit" class="nav-link mt-4 ps-0 pb-0 " name="btn_category" id="btn_category"><?php echo $row['category_name'] ?></button>
                            </form>
                            <?php 
                            ...
                            <ul class="nav nav-pills flex-column mt-2 ">
                                <li class="nav-item py-2 py-sm-0">
                                    <form action="category.php" method="get">
                                        <input type="hidden" name="sidebar_subcategory" id="sidebar_subcategory" value="<?php echo $sub_cat['id'] ?>">
                                        <button type="submit" class=" text-white nav-link pt-0 " name="btn_subcategory" id="btn_subcategory"><?php echo $sub_cat['category_name'] ?></button>
                                    </form>
                            </ul>
                            <?php }?>
                        </li>
                ...
                <div id="result_serach">
                    ...
                    ?>
                            <tr>
                                ...
                                <td class="ps-4 pt-4"><?php echo $row['category_name'] ?> </td>
